...
> **⚠ v0.7.2 修订(2026-09-12)**:`cutflow-prompt` 技能组**已停用并归档**到 `docs/archive/cutflow-prompt/`(见 `docs/OPTIMIZATION-v7.md` #5:"先完善第一个技能,第二个删掉")。本文中凡涉及它的段落(Q1 / Q15 / §4.1 / §6.3 / §9 结构 / M5)一律视为**历史记录**,不再维护;`tools/install.ps1` 现在只安装 `cutflow`。
...
### 6.3 cutflow-prompt 技能（v0.7.2 已停用，见归档）
